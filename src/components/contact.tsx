const Contact = () => {
  return (
    <section
      style={{ backgroundColor: "rgb(0, 106, 188)" }}
      className="bg-blue-600 min-h-screen p-8"
    >
          ...
          <div className="text-white">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-md">+91 22 25208822</p>
              </div>

              <div>
                <p className="text-xl mb-1">Email:</p>
                <p className="text-md">info@superenergygroup.co.in</p>
              </div>
            </div>
          </div>
